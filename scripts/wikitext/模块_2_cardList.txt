...
function p.card_list(frame)
    ...
    ul:tag('li'):tag('div'):addClass('filter-div--button selected'):attr('data-type', 'all'):wikitext('全部')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features1'):attr('data-features1', 3):wikitext('飞行')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features1'):attr('data-features1', 4):wikitext('地面')
    --按远程/近战过滤
    ul = group_div:tag('ul'):addClass('filter-div--bgroup filter-list')
    ul:tag('li'):tag('div'):addClass('filter-list--title'):wikitext('类型')
    ul:tag('li'):tag('div'):addClass('filter-div--button selected'):attr('data-type', 'all'):wikitext('全部')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features2'):attr('data-features2', 5):wikitext('远程')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features2'):attr('data-features2', 6):wikitext('近战')
    --按类型过滤
    ul = group_div:tag('ul'):addClass('filter-div--bgroup filter-list')
    ul:tag('li'):tag('div'):addClass('filter-list--title'):wikitext('定位')
    ul:tag('li'):tag('div'):addClass('filter-div--button selected'):attr('data-type', 'all'):wikitext('全部')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 7):wikitext('肉盾')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 8):wikitext('战士')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 9):wikitext('刺客')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 10):wikitext('射手')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 11):wikitext('施法者')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 12):wikitext('召唤师')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 13):wikitext('辅助')
    ul:tag('li'):tag('div'):addClass('filter-div--button'):attr('data-type', 'features3'):attr('data-features3', 14):wikitext('特殊')
